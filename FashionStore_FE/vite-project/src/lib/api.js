...
const api = axios.create({
  baseURL: import.meta.env.VITE_API_URL,     // ví dụ: https://vytaifashionstore-production.up.railway.app/api
  withCredentials: false,                    // không dùng cookie/Sanctum
  headers: { Accept: 'application/json' },
});

// Các helper tương thích với code cũ
...
// Vẫn export mặc định nếu bạn muốn dùng trực tiếp axios instance
export default api;
