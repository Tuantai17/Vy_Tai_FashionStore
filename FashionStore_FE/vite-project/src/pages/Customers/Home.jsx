...
export default function Home() {
  ...
  return (
    <>
            ...
            <section className="py-16 px-4 bg-gradient-to-b from-gray-50 to-white dark:from-neutral-950 dark:to-neutral-900">
              ...
              >
                ...
                <p className="text-lg leading-8 text-gray-600 dark:text-neutral-300">
                  <strong className="text-gray-900 dark:text-white">Fashion Store</strong> là điểm đến
                  lý tưởng cho những ai yêu thích phong cách và sự khác biệt. Chúng tôi mang đến các
                  bộ sưu tập thời trang từ thường ngày đến cao cấp, giúp bạn tự tin thể hiện cá tính riêng.
                </p>
      ...
      {/* ===== Floating chat widget (nút + panel) — luôn nổi trên mọi nội dung ===== */}
      <ChatWidget floating />
    </>
  );
}
