  ...
  return (
    <section>
      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 12 }}>
        ...
        <Link to="/admin/orders" style={{ border: "1px solid #ddd", padding: "6px 10px", borderRadius: 6 }}>← Quay lại</Link>
      </div>
      ...
      <div style={{ display: "grid", gap: 12, gridTemplateColumns: "1fr 1fr", marginBottom: 16 }}>
        ...
        <div style={{ background: "#fff", border: "1px solid #eee", borderRadius: 8, padding: 12 }}>
          ...
          <div style={{ marginTop: 6 }}>Tạo lúc: {new Date(order.created_at).toLocaleString()}</div>
